...
if __name__ == "__main__":
    ...
    data_module = QM9DataModule(target=5, batch_size_train=256, batch_size_inference=256, num_workers=8)
    data_module.prepare_data()
    data_module.setup()

    baseline_module = BaselineRegressionModel(
